...
export default function ProjectCard({ project, index, isInView, lang, categoryLabel }: ProjectCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        >
          <span className="mr-2">{lang === "es" ? "Ver detalles" : "View details"}</span>
      ...
      {/* Category badge */}
      <div className="absolute top-4 right-4 px-3 py-1 rounded-full text-xs font-medium bg-white/80 backdrop-blur-sm text-gray-800">
        {categoryLabel}
      </div>
    </motion.div>
  )
